...
| **497-test suite** | `pytest` (functional + KAT + property/fuzz + interop) | the code path actually exercised |
...
`REPRODUCE.md` re-derives the 497 tests + the proofs + the constant-time measurement from a clean
