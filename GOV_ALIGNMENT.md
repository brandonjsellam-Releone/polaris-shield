...
| Sovereign fault-tolerant quantum-compute trajectory (public anchor) | DARPA Quantum Benchmarking Initiative | out-of-scope | The VALYON citadel is speculative / order-of-magnitude and is honestly weaker than the public DARPA QBI program — a framing anchor, not a capability claim. |
