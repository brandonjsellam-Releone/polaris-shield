...
> KEM legs broken + PPK intact => secret* — UNBOUNDED in Tamarin (12 lemmas) and ProVerif, CI-gated alongside
> `shield.spthy`. The last "argued, not proved" combiner leg is now proved in both unbounded lineages.
