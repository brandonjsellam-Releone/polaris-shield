...
> **What this adds.** ACVP + the 508-test suite + hypothesis fuzzing show the *primitives* are
...
- **Out of scope:** constant-time / side-channel / timing behaviour, FIPS 140-3 validation,
  and the wire-encoding length-framing fidelity (the codec is covered by ACVP + the 508-test
