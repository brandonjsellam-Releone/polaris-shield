...
ASSETS = [
    ...
    ("SLH-DSA", "signature", "SLH-DSA (hash-based)", ["keygen", "sign", "verify"], True, 5,
     "FIPS 205", ["high-assurance (opt-in dual/triple-sign)"], None),
    ("Ed25519", "signature", "Ed25519", ["keygen", "sign", "verify"], False, 0,
     "RFC 8032", ["high-assurance (opt-in triple-sign, classical leg)"], "1.3.101.112"),
    ("Ed448", "signature", "Ed448", ["keygen", "sign", "verify"], False, 0,
     "RFC 8032", ["high-assurance (opt-in triple-sign, classical leg)"], "1.3.101.113"),
